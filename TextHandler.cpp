...
const std::map<std::string, int>& TextHandler::getWordStatistics() const {
    return *wordStatistics; // 
}
long long TextHandler::getWordquantity() const {
    return wordquantity;
}
...
std::ostream& operator<<(std::ostream& out, const TextHandler& handler) {
    ...
    out << "Unique: " << handler.getWord() << std::endl;
    out << "Matches in text: " << std::endl;
    out << handler.getWordStatistics() << std::endl;
